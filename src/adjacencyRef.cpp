...
AdjacencyMatrixRef generate_adjacency_matrix_uniform(
    ...
    AdjacencyMatrixRef adj = new Link*[V2E.size() + 1];
...
AdjacencyMatrixRef generate_adjacency_matrix_pointcloud(
    ...
    AdjacencyMatrixRef adj = new Link*[V.size() + 1];
